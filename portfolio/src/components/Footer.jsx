      ...
      <div className="container mx-auto px-6 pt-12 pb-8">
        <div className="flex flex-col md:flex-row justify-between">
          ...
          <div className="md:w-1/3 mb-10 md:mb-0">
            <h2 className="text-2xl font-bold text-white mb-4">Kowshik Valipireddy</h2>
            <p className="mb-4 pr-4 text-gray-400">
              A passionate developer focused on creating intuitive, dynamic user experiences
          ...
          <div className="md:w-1/4 mb-10 md:mb-0">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#" className="text-gray-400 hover:text-white transition-colors duration-300">Skills</a>
              </li>
              <li>
          ...
          <div className="md:w-1/4">
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">kowshikvalipireddy@gmail.com</span>
              </li>
              <li className="flex items-start">
                <div className="text-indigo-400 mr-3 mt-1">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-gray-400">8328107601</span>
              </li>
              <li className="flex items-start">
                <div className="text-indigo-400 mr-3 mt-1">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              ...
              <p className="text-gray-400 text-sm">Subscribe to my newsletter for latest updates</p>
            </div>
            <div className="w-full md:w-1/3">
              <div className="flex">
                <input
                  ...
                  className="w-full px-4 py-2 text-gray-900 bg-white rounded-l focus:outline-none"
                />
                <button className="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-r transition duration-300">
                  Subscribe
                </button>
              </div>
            </div>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-sm text-gray-500">
              © {currentYear} Kowshik Valipireddy❤️. All rights reserved.
            </div>
            <div className="mt-4 md:mt-0">
              <ul className="flex space-x-6 text-sm">
                ...
                <li>
                  <a href="#" className="text-gray-500 hover:text-gray-400 transition-colors duration-300">Sitemap</a>
                </li>
              </ul>
            </div>
          </div>
